const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dataSaver.hint': 'Warnt vor großen Uploads/Downloads und bevorzugt WLAN. „Auto“ aktiviert ihn während deiner Reisedaten. Diese Einstellung gilt pro Gerät.',
  'dataSaver.modeAuto': 'Auto (an während Reisen)',
  'dataSaver.modeOn': 'Immer an',
  'dataSaver.modeOff': 'Aus',
  'dataSaver.chip': 'Datensparmodus',
  'dataSaver.chipTooltip': 'Datensparmodus ist an — große Uploads/Downloads warten auf WLAN. Zum Ändern tippen.',
  'dataCost.title': 'Hinweis — Datennutzung',
  'dataCost.message': '{op} verbraucht etwa {size} an Daten.',
  'dataCost.messageSaver': '{op} verbraucht etwa {size} an Daten. Datensparmodus ist an — besser auf WLAN warten.',
  'dataCost.messageUnknown': '{op} kann viele Daten verbrauchen (enthält alle Fotos und Dateien).',
  'dataCost.messageUnknownSaver': '{op} kann viele Daten verbrauchen (alle Fotos und Dateien). Datensparmodus ist an — besser auf WLAN warten.',
  'dataCost.waitWifi': 'Auf WLAN warten',
  'dataCost.continue': 'Fortfahren',
  'dataCost.continueAnyway': 'Trotzdem fortfahren',
  'dataCost.op.photoUpload': 'Diese Fotos hochladen',
  'dataCost.op.offlineDownload': 'Diese Reise für offline herunterladen',
  'dataCost.op.exportBundle': 'Diese Reise als Bundle exportieren',
  'dataCost.op.backupRestore': 'Dieses Backup hochladen',
  ...
  'photos.uploadSuccess': 'Foto hinzugefügt',
  'settings.checkPhotoTimestamp': 'Warnen, wenn das Foto-Datum nicht zum Tag passt',
  'settings.checkPhotoTimestampHint': 'Zeigt eine Warnung, wenn ein einzelnes Foto an einem Tag hochgeladen wird, dessen Datum nicht mit dem EXIF-Aufnahmedatum des Fotos übereinstimmt. Ausschalten, wenn du Fotos absichtlich bestimmten Tagen zuordnest (Souvenirs, Scans, Platzhalter).',
  'dayplan.dayN': 'Tag {n}',
