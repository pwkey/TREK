const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dataSaver.hint': 'Warns before large uploads/downloads and prefers Wi-Fi. “Auto” turns it on during your trip dates. This setting is per-device.',
  'dataSaver.modeAuto': 'Auto (on during trips)',
  'dataSaver.modeOn': 'Always on',
  'dataSaver.modeOff': 'Off',
  'dataSaver.chip': 'Data saver',
  'dataSaver.chipTooltip': 'Data saver is on — large uploads/downloads wait for Wi-Fi. Tap to change.',
  'dataCost.title': 'Heads up — data usage',
  'dataCost.message': '{op} will use about {size} of data.',
  'dataCost.messageSaver': '{op} will use about {size} of data. Data saver is on — better to wait for Wi-Fi.',
  'dataCost.messageUnknown': '{op} may use a lot of data (it includes all photos and files).',
  'dataCost.messageUnknownSaver': '{op} may use a lot of data (all photos and files). Data saver is on — better to wait for Wi-Fi.',
  'dataCost.waitWifi': 'Wait for Wi-Fi',
  'dataCost.continue': 'Continue',
  'dataCost.continueAnyway': 'Continue anyway',
  'dataCost.op.photoUpload': 'Uploading these photos',
  'dataCost.op.offlineDownload': 'Downloading this trip for offline use',
  'dataCost.op.exportBundle': 'Exporting this trip as a bundle',
  'dataCost.op.backupRestore': 'Uploading this backup',
  ...
  'settings.about.description': '460 Trip Planner is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  ...
  'login.createAdminHint': 'Set up the first admin account for 460 Trip Planner.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your 460 Trip Planner experience.',
  ...
  'admin.weather.description': '460 Trip Planner uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building 460 Trip Planner',

  'admin.update.available': 'Update available',
  'admin.update.text': '460 Trip Planner {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText': '460 Trip Planner will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText': 'Your 460 Trip Planner instance runs in Docker. To update to {version}, run the following commands on your server:',
  ...
  'vacay.sharingHint': 'Share your vacation plan with other 460 Trip Planner users',
  'vacay.owner': 'Owner',
  'vacay.shareEmailPlaceholder': 'Email of 460 Trip Planner user',
  ...
  'vacay.inviteHint': 'Invite another 460 Trip Planner user to share a combined vacation calendar.',
  ...
  'errorBoundary.back': 'Back to dashboard',
  ...
  'trip.confirm.dupAssignTitle': 'Already on this day',
  'trip.confirm.dupAssign': '{place} is already on {day}. Add it again?',
  ...
  'settings.checkPhotoTimestamp': 'Warn when photo date doesn’t match day',
  'settings.checkPhotoTimestampHint': 'Shows a warning when uploading a single photo to a day whose date doesn’t match the photo’s EXIF capture date. Turn off if you regularly assign photos to days deliberately (souvenirs, scans, placeholders).',
  'dayplan.dayN': 'Day {n}',
  ...
  'dayplan.jump': 'Jump to',
  'dayplan.jumpTooltip': 'Jump to a section of the trip',
  'dayplan.jumpEmpty': 'No sections yet. Open a day and name a section to add one.',
  'day.section': 'Section',
  'day.sectionHint': 'Name a leg here (e.g. “Morocco”) to jump to it. Runs until the next named day.',
  'day.sectionPlaceholder': 'e.g. Morocco',
  'day.sectionSave': 'Save',
  'day.sectionClear': 'Clear',
  'dayplan.pdf': 'PDF',
  ...
  'places.onDays': 'Day {days}',
  'places.scheduledOn': 'Scheduled on {days}',
  'places.nonePlanned': 'No places are planned yet',
  'places.addAgain': 'Add again',
  ...
  'files.previewMobile': 'PDF preview isn’t available on mobile. Open it in your browser instead.',
  'files.previewFallback': 'This file can’t be previewed here.',
  ...
  'notifications.versionAvailable.text': '460 Trip Planner {version} is now available.',
  ...
  'notif.version_available.text': '460 Trip Planner {version} is now available',
